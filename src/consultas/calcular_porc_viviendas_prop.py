...
nombre_aglomerados = {"2": "Gran La Plata", "3": "Bahía Blanca - Cerri", "4": "Gran Rosario", 
...
def imprimir_viviendas_propias_por_aglomerado():
    ...
    porcentajes = porcentaje_viviendas_propias_por_aglomerado(hogares, nombre_aglomerados)
